...
DIFFUSION_MODELS=(
    ...
    # wan22 5b fun inpaint bf16 10gb
    wan22_5b_fun_inpaint_bf16 "https://huggingface.co/alibaba-pai/Wan2.2-Fun-5B-InP/resolve/main/diffusion_pytorch_model.safetensors::Wan2.2-Fun-5B-InPaint.safetensors"
